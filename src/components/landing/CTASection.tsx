          ...
          <div className="text-left max-w-2xl mx-auto space-y-4 mb-8">
            <ul className="space-y-3 text-lg text-muted-foreground leading-relaxed">
              <li className="flex items-start gap-3">
                ...
                <span>
                  Complete 3Ds Framework training with step-by-step build guides
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-white flex-shrink-0 mt-0.5" />
                <span>
                  3 plug-and-play workflow templates you can deploy this weekend
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-white flex-shrink-0 mt-0.5" />
                <span>
                  The Smart Lead Tracker system (automatically tracks all your
                  leads)
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-white flex-shrink-0 mt-0.5" />
                <span>
                  The Instant Responder system (sends an automated reply to new
                  leads)
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-white flex-shrink-0 mt-0.5" />
                <span>
                  The Daily Ops Digest (daily email summary of new leads and one
                  next step)
                </span>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-white flex-shrink-0 mt-0.5" />
                <span>
                  Lifetime Evolution Access (all future updates included
                  forever)
                </span>
              </li>
              <li className="flex items-start gap-3">
